...
export const ButtonGroup = ({children, variant = "default", disabled = false, size = "medium", ...props}: Props) => {
    /**
    ...
    const renderButtons = (): ReactNode[] => {
        ...
        const buttons: JSX.Element[] = components.Button.map((button: FoundChild) => {
            ...
            const {disabled, className, href, ...buttonProps} = component.props;
            ...
            return (
                ...
                >
                    {href ? <a href={href}>{component.props.children}</a> : component.props.children}
                </button>
            )
        })
