...
<Canvas>
	<Story name="Different Starting Day" args={{ startDate: '2020-04-20' }}>
		{StandardCalendar.bind({})}
	</Story>
</Canvas>
...
<Canvas>
	<Story name="Valid Date Range" args={{ startDate: '2020-04-20', dateRange: ['2020-04-03', '2020-04-24'] }}>
		{StandardCalendar.bind({})}
	</Story>
</Canvas>
...
<Canvas>
	<Story name="Marked Dates" args={{ startDate: '2020-04-20', marks: ['2020-04-03', '2020-04-24', '2020-04-20'] }}>
		{StandardCalendar.bind({})}
	</Story>
</Canvas>
