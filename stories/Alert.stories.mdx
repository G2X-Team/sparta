...
A basic Alert component that allows for extensive customization via prop changes

The Alert component is a Basic component that informs the user about a situation.
It can be used to notify the user of a form successful submission, or to notify the user of an error.
It allows for extensive customization via prop changes.

## Table of Contents

In this documentation we talk about the Alert component, its functionality, types and props.
...
the consideration that this component has access to all the props and functionality of the `Text` component as well.
