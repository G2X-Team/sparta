...
When we refer to an `Accordion` in Sparta, we really mean a single dropdown that can be
...
We can decide whether we want to let Sparta deal with the opening and closing logic,
